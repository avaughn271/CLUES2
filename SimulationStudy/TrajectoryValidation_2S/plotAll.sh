...
python3.10 ~/desktop/CLUES2/inference.py --popFreq 0.25 --ancientSamps TrueSamplesNew.txt --N 30000 --out output --tCutoff 403 --df 600 --integration_points 100 --timeBins 200
