...
python3.10 ./inference005.py  --popFreq  $modernfreq --times INPUTTIMES/Times${c}.txt --N $N --out TrueResults/output${c} --df $discretization --tCutoff 10000 --noAlleleTraj #changed cutoff from 1000 to 10000
