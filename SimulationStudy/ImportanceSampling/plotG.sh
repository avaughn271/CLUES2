...
LL="1e6"
muu="4e-9"       #number1
let numimpsamples=300
totaliter=250000   #changed!!!
...
time python3.10 ~/desktop/CLUES2/inference.py --popFreq  $modernfreq --times INPUTTIMES/Times${c}.txt --N $N --out TrueResults/output${c} --df $discretization --tCutoff 2000  --noAlleleTraj  #CHANGEEEE1
echo "endclues"
