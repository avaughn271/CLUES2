...
if (nextgeneration > (timeofmutation -  200    ))  {selectioncoef = -0.005} else 
if (nextgeneration > (timeofmutation -  600    ))  {selectioncoef = 0.0} else {
     selectioncoef = 0.01     } 
#print(c(nextgeneration ,selectioncoef, timeofmutation))
    p = currentfreq
