...
desiredquantiles = seq(0.00001, max(vals), length.out = 10000)
...
plot(actual,experimental, xlim = c(0,1), ylim = c(0,1), pch = 19, col = "steelblue4", main = "s = 0.005", xlab = "Theoretical Distribution Function", ylab = "Empirical Distribution Function")
