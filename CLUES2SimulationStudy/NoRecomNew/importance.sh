...
let NUMTRIALS=5  #POSITION2
modernfreq=".75"
let discretization=1100      ##edited this
let numleaves=40    #changed this tooooo
LL="1e6"              
muu="7e-9"       #number1
let numimpsamples=500
totaliter=400000   #changed!!!
...
time python3.10 ~/desktop/CLUES2/inference.py --popFreq  $modernfreq --times INPUTTIMES/Times${c}.txt --N $N --out TrueResults/output${c} --df $discretization --tCutoff 2000  --noAlleleTraj #CHANGEEEE
echo "endclues"
